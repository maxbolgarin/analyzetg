"""CLI commands: atg export, atg dump.
...
from atg.core.paths import slugify as _slugify
from atg.db.repo import Repo, open_repo
from atg.export.markdown import export_csv, export_jsonl, export_md
...
async def cmd_dump(
    *,
    ...
    if ref is None:
        from atg.interactive import run_interactive_dump
    ...
    from atg.analyzer.commands import _derive_internal_id
...
async def _dump_single(
    *,
    ...
    if save_media and prepared.messages:
        from atg.media.commands import save_raw_media
...
async def _dump_forum_per_topic(
    *,
    ...
    """
    from atg.analyzer.commands import _chat_slug, _topic_slug
...
async def _transcribe_pending(
    *,
    ...
    from atg.enrich.audio import transcribe_message
...
def _print_console(msgs: list[Message], *, title: str | None, fmt: str, count: int) -> None:
    ...
    if fmt == "md":
        ...
        from atg.export.markdown import render_md
