...
from atg.analyzer.pipeline import AnalysisOptions, AnalysisResult, run_analysis
from atg.analyzer.prompts import Preset, get_presets, load_custom_preset
from atg.config import get_settings
from atg.core.paths import chat_slug as _chat_slug
from atg.core.paths import compute_window as _compute_window
from atg.core.paths import derive_internal_id as _derive_internal_id
from atg.core.paths import has_explicit_period as _has_explicit_period
from atg.core.paths import parse_ymd as _parse_ymd
from atg.core.paths import slugify as _slugify  # noqa: F401  re-export for tests
from atg.core.paths import topic_slug as _topic_slug
from atg.core.paths import unique_path as _unique_path
...
from atg.tg.client import tg_client
from atg.tg.resolver import resolve
from atg.tg.topics import ForumTopic, list_forum_topics
...
async def _self_check(
    *,
    ...
    from atg.analyzer.openai_client import build_messages, chat_complete, make_client
...
async def cmd_analyze(
    *,
    ...
    if ref is None:
        from atg.interactive import run_interactive_analyze
    ...
    effective_ref = ref
    if msg:
        from atg.tg.links import parse as _parse_link
    ...
    from atg.youtube.urls import is_youtube_url as _is_yt
    ...
    if effective_ref and _is_yt(effective_ref):
        ...
        from atg.youtube.commands import cmd_analyze_youtube
    ...
    from atg.website.urls import is_telegram_url as _is_tg_url
    from atg.website.urls import is_website_url as _is_web
    ...
    if effective_ref and _is_web(effective_ref) and not _is_tg_url(effective_ref):
        ...
        from atg.website.commands import cmd_analyze_website
    ...
    async with tg_client(settings) as client, open_repo(settings.storage.data_path) as repo:
        ...
        if is_forum and all_flat:
            ...
            from atg.tg.topics import list_forum_topics
...
async def _run_single_msg(
    *,
    ...
    from atg.tg.sync import normalize
...
async def _run_single(
    *,
    ...
    from atg.enrich.base import EnrichOpts as _EnrichOpts
    ...
    if dry_run:
        ...
        if loaded_preset is None:
            ...
            return
        from atg.analyzer.pipeline import estimate_cost as _estimate_cost
    ...
    if prepared.comments_chat_id is not None:
        from atg.analyzer.formatter import build_link_template as _build_lt
...
async def _run_forum_per_topic(
    *,
    ...
    """
    from atg.core.pipeline import prepare_chat_runs_per_topic
    from atg.enrich.base import EnrichOpts as _EnrichOpts
...
async def _post_to_chat(
    ...
    *,
    ...
    """
    header = f"📊 atg — {title or result.chat_id}\npreset: {result.preset}\n"
    ...
    if target_norm in ("me", "saved", ""):
        ...
        from atg.tg.resolver import resolve as _resolve
