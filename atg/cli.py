"""atg CLI (Typer). Commands are wired in later phases; stubs here
...
from atg.db.repo import apply_db_overrides_sync, open_repo
from atg.i18n import t as _t
from atg.i18n import tf as _tf
from atg.util.logging import setup_logging
...
def init() -> None:
    ...
    from atg.tg.commands import cmd_init
...
def describe(
    ...
    """
    from atg.tg.commands import cmd_describe
...
def dialogs(
    ...
    from atg.tg.commands import cmd_dialogs
...
def topics(
    ...
    from atg.tg.commands import cmd_topics
...
def resolve(anything: str = typer.Argument(...)) -> None:
    ...
    from atg.tg.commands import cmd_resolve
...
def channel_info(ref: str = typer.Argument(...)) -> None:
    ...
    from atg.tg.commands import cmd_channel_info
...
def chats_add(
    ...
    """
    from atg.tg.commands import cmd_chats_add
...
def chats_manage() -> None:
    ...
    """
    from atg.tg.commands import cmd_chats_manage
...
async def _list_folders() -> None:
    ...
    from atg.tg.folders import list_folders
...
def sync(
    ...
    from atg.tg.commands import cmd_sync
...
def chats_run(
    ...
    """
    from atg.runner import cmd_run
...
def backfill(
    ...
    """
    from atg.tg.commands import cmd_backfill
...
def analyze(
    ref: str | None = typer.Argument(
        ...
        help=(
            ...
            "`atg analyze -- -1001234567890`. Omit to pick every dialog "
...
def download_media(
    ...
    """
    from atg.media.commands import cmd_download_media
...
def stats(
    ...
    from atg.analyzer.commands import cmd_stats
...
def settings() -> None:
    ...
    sub-commands.
    """
    from atg.settings.commands import cmd_settings
...
def doctor() -> None:
    ...
    from atg.tg.commands import cmd_doctor
...
def export(
    ...
    from atg.export.commands import cmd_export
...
def dump(
    ref: str | None = typer.Argument(
        ...
        help=(
            "Chat reference: @user, t.me link, title (fuzzy), or numeric id. "
            "For a negative numeric id use `--` to separate from flags, e.g. "
            "`atg dump -- -1001234567890 -o out.md`. Omit to pick every "
    ...
    thread: int | None = typer.Option(
        None,
        "--thread",
        help="Forum-topic id. Run `atg topics <ref>` first to list topic ids.",
    ),
    from_msg: str | None = typer.Option(None, "--from-msg", help="Start at this msg_id (or a message link)."),
...
def compute_period(
    ...
    from atg.core.paths import compute_window
