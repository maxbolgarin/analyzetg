...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    # ---- Wizard banner / tips ------------------------------------------
    "wiz_banner": {
        "en": "atg — interactive mode  (action: {action})",
        "ru": "atg — интерактивный режим  (действие: {action})",
    },
    "wiz_tips": {
    ...
    "wiz_pick_chat_to_describe": {
        "en": "atg — pick a chat to describe",
        "ru": "atg — выберите чат для описания",
    },
    ...
    "tg_doctor_banner": {"en": "atg doctor", "ru": "atg doctor"},
...
def t(key: str, lang: str | None = None) -> str:
    ...
    if key not in _STRINGS:
        raise KeyError(f"i18n: unknown key {key!r}. Add it to atg/i18n.py.")
    if lang is None:
