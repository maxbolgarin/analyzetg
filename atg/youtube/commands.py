"""Top-level handler for `atg analyze <youtube-url>`.
...
from atg.analyzer.pipeline import (
    AnalysisOptions,
    estimate_cost,
    run_analysis,
)
...
from atg.youtube.metadata import YoutubeMetadata, fetch_metadata
from atg.youtube.paths import youtube_report_path
from atg.youtube.transcript import (
    NoTranscriptAvailable,
    TranscriptSource,
    get_transcript,
)
from atg.youtube.urls import extract_video_id
