...
from analyzetg.db.repo import _apply_one_override, apply_db_overrides_sync, open_repo
...
async def _pick_language(
    ...
    *,
    ...
    from analyzetg.i18n import LANGUAGE_NAMES
    from analyzetg.interactive import LIST_STYLE, _bind_escape
...
def _supported_locale_languages() -> list[str]:
    ...
    from analyzetg.analyzer.prompts import PRESETS_DIR
    from analyzetg.i18n import _STRINGS
