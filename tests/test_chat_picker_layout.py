...
async def test_pick_chat_offers_all_local_when_flag_set(monkeypatch):
    ...
    monkeypatch.setattr(
        "unread.tg.folders.chat_folder_index",
        fake_folder_index,
    )
...
async def test_pick_chat_no_unread_with_offer_all_local_still_shows_all_local(monkeypatch):
    ...
    monkeypatch.setattr(
        "unread.tg.dialogs.correct_forum_unread",
    ...
    monkeypatch.setattr("unread.tg.client.entity_id", lambda e: e.id)
    monkeypatch.setattr("unread.tg.client.entity_title", lambda e: e.title)
    monkeypatch.setattr("unread.tg.client.entity_username", lambda e: e.username)
    monkeypatch.setattr("unread.tg.client._chat_kind", lambda _e: "user")
    monkeypatch.setattr(interactive.questionary, "select", fake_select)
